      ...
      <div class="relative mx-auto max-w-4xl px-4 z-10 w-full flex-grow">
        ...
        <div class="space-y-8 text-xs sm:text-sm text-muted-foreground leading-relaxed font-sans max-w-3xl">
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">1. Gift Card Trade Eligibility</h2>
            <p>
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">2. Rates & Quote Lock</h2>
            <p>
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">3. Submission Verification & Payout Runs</h2>
            <p>
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">4. Zero-Tolerance Fraud Policy</h2>
            <p>
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">5. Limitation of Liability</h2>
            <p>
