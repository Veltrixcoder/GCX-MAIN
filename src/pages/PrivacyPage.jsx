...
export function PrivacyPage() {
  return (
    <div class="relative min-h-screen pt-32 pb-12 overflow-hidden flex flex-col justify-between bg-background">
      ...
      <div class="relative mx-auto max-w-4xl px-4 z-10 w-full flex-grow">
        {/* Back Link */}
        ...
        {/* Title */}
        <div class="mb-10 text-left border-b border-border/40 pb-6">
          <p class="text-[10px] font-bold font-sans uppercase tracking-wider text-primary mb-2">Legal Docs</p>
          <h1 class="text-3xl sm:text-5xl font-bold font-display tracking-tight text-foreground">
            Privacy Policy
          </h1>
          <p class="text-xs text-muted-foreground mt-3 font-sans">
            Last Updated: June 11, 2026
          </p>
        </div>

        {/* Policy Content */}
        <div class="space-y-8 text-xs sm:text-sm text-muted-foreground leading-relaxed font-sans max-w-3xl">
          <p>
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">1. Information We Collect</h2>
            <p>
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">2. How We Use Your Data</h2>
            <p>
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">3. Security Practices</h2>
            <p>
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">4. Data Sharing & Retention</h2>
            <p>
          ...
          <section class="space-y-3">
            <h2 class="text-sm sm:text-base font-bold text-foreground font-display">5. Contact Information</h2>
            <p>
              If you have any questions, concerns, or requests regarding your data privacy, please reach out to our legal desk at <a href="mailto:support@gcx.co.in" class="text-primary hover:underline font-semibold">support@gcx.co.in</a>.
            </p>
          </section>
        </div>
      </div>
